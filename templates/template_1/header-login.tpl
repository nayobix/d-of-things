...
<html style="" class="iegt9 js no-touch svg inlinesvg svgclippaths no-ie8compat wf-proximanova-n4-inactive wf-proximanova-n7-inactive wf-proximanova-i4-inactive wf-proximanova-i7-inactive wf-proximanova-n3-inactive wf-inactive" lang="{$smarty.const.SITE_LANGUAGE}">
    ...
    <head>
        ...
        <link href="{$smarty.const.SITE_URL}templates/{$smarty.const.TEMPLATE_DIR}/dofthings_files/login-style.css" media="screen" rel="stylesheet" type="text/css">

        {literal}
            <style type="text/css">.tk-proxima-nova{font-family:"proxima-nova",sans-serif;}
            {/literal}
            ...
            {literal}
                <style type="text/css"></style><style type="text/css" charset="utf-8">/* See license.txt for terms of usage */
                /** reset styling **/
                .firebugResetStyles {
                    ...
                    <section class="app-header-content">
                        ...
                        <ul class="left">
                            <li class="app-header-platform ">
                                <a href="/dashboards">{$smarty.const.MENU1}</a>
                        <!--        <ul class="dropdown"><li class="title back js-generated"><h5><a href="#">{$smarty.const.MENU1}</a></h5></li>
                                  <li><a href="index.php">{$smarty.const.SUBMENU1_MENU1}</a></li>
                                  <li><a href="index.php">{$smarty.const.SUBMENU2_MENU1}</a></li>
                                  <li><a href="index.php">{$smarty.const.SUBMENU3_MENU1}</a></li>
                                  <li><a href="index.php">{$smarty.const.SUBMENU4_MENU1}</a></li>
                                </ul>
                                -->
                            </li>
                            <li class="">
            ...
            {if $login_error}
                <div class="alert-box info">
                    <div class="alert-box-inner">
                        {$smarty.const.HEADER_NAV_LOGIN_FAIL}
                    </div>
                </div>
            {elseif $success}
